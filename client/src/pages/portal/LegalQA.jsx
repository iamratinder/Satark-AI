      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-indigo-300 mt-2 text-sm">
            Pose any legal question and receive precise answers with case law and statutory references.
          </p>
        </motion.div>
        ...
        <AnimatePresence>
          {!response && !isLoading && (
            <motion.div
              ...
              className="mb-8"
            >
              <h3 className="text-sm font-medium text-indigo-400 mb-2">Explore these queries:</h3>
          ...
          >
            ...
            <div className="p-5 text-indigo-200">
              ...
              {response.sources?.length > 0 && (
                ...
                >
                  <h4 className="text-lg font-medium text-cyan-400 mb-2">Legal References:</h4>
                  <ul className="space-y-2">
                    {response.sources.map((source, idx) => (
                      ...
                      >
                        <div><span className="font-medium text-cyan-400">Source:</span> {source.title}</div>
                        {source.citation && (
                          <div><span className="font-medium text-cyan-400">Citation:</span> {source.citation}</div>
                        )}
                        {source.excerpt && (
